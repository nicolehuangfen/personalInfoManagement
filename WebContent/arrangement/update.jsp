...
<script type="text/javascript">
	function changeSubmit() {
		...
		form.action = "../arrangement/update";
		form.submit();
	}
</script>
<style>
...
<body>
	<s:form action="/arrangement/inputDate" method="post">
		<div id="updateDiv">
			<span id="a">请输入要修改的日程日期：</span><input type="text" id="updateInp"
		...
		<table id="myTab" border="1px">
			<tr>
				<td colspan="2"
					style="padding-left: 200px; background-color: #0000FF; color: yellow">修改日程</td>
			</tr>
			<tr>
				<td>日程日期：</td>
